...
state test
{
    ...
    {
        if(message != "Added agent \"Script.Test @localhost:9300\" to allowed list for estate \"My Estate\"")
        {
...
state test2
{
    ...
    improvedinstantmessage_received(
        ...
        bytearray binaryBucket)
    {
        if(message != "Removed agent \"Script.Test @localhost:9300\" from allowed list for estate \"My Estate\"")
        {
            llSay(PUBLIC_CHANNEL, "Unexpected message. Got: " + message);
            result = FALSE;
        }
...
state test3
{
    ...
    improvedinstantmessage_received(
        ...
        bytearray binaryBucket)
    {
        if(message != "Added agent \"List.Test @localhost:9300\" to allowed list for estate \"My Estate\"")
        {
            llSay(PUBLIC_CHANNEL, "Unexpected message. Got: " + message);
            result = FALSE;
        }
...
state test4
{
    ...
    improvedinstantmessage_received(
        ...
        bytearray binaryBucket)
    {
        if(message != "Removed agent \"List.Test @localhost:9300\" from allowed list for estate \"My Estate\"")
        {
            llSay(PUBLIC_CHANNEL, "Unexpected message. Got: " + message);
            result = FALSE;
        }
