...
const integer LINK0_LOCALID = _test_ObjectKey2LocalId("11223344-1122-1122-1122-000000000000");
...
state test
{
    state_entry()
    {
		...
		vagent.SendObjectLink([LINK4_LOCALID, LINK0_LOCALID]);
    }
...
state link_link3
{
	state_entry()
	{
		...
		vagent.SendObjectLink([LINK3_LOCALID, LINK0_LOCALID]);
	}
...
state link_link2
{
	state_entry()
	{
		...
		vagent.SendObjectLink([LINK2_LOCALID, LINK0_LOCALID]);
	}
...
state link_link1
{
	state_entry()
	{
		...
		vagent.SendObjectLink([LINK1_LOCALID, LINK0_LOCALID]);
	}
