...
state test
{
	...
	state_entry()
	{
		...
		llSay(PUBLIC_CHANNEL, "Sending MultipleObejctUpdate.Scale => <128,128,100>");
		llSetTimerEvent(1.0);
		vagent.SendMultipleObjectUpdate([_test_ObjectKey2LocalId("11223344-1122-1122-1122-000000000001"), 0, 0, EXPECTED]);
	}
...
state test2
{
	...
	state_entry()
	{
		llSay(PUBLIC_CHANNEL, "Sending MultipleObejctUpdate.Scale => <129,129,24>");
		llSetTimerEvent(1.0);
		vagent.SendMultipleObjectUpdate([_test_ObjectKey2LocalId("11223344-1122-1122-1122-000000000001"), 0, 0, EXPECTED]);
	}
