...
setglow(float glow, integer face)
{
    llSetPrimitiveParams([PRIM_GLOW, face, glow]);
}
...
displayteglow(textureentry te)
{
    llSay(PUBLIC_CHANNEL, "TE[0]: " + te[0].Glow);
    llSay(PUBLIC_CHANNEL, "TE[1]: " + te[1].Glow);
    llSay(PUBLIC_CHANNEL, "TE[2]: " + te[2].Glow);
    llSay(PUBLIC_CHANNEL, "TE[3]: " + te[3].Glow);
    llSay(PUBLIC_CHANNEL, "TE[4]: " + te[4].Glow);
    llSay(PUBLIC_CHANNEL, "TE[5]: " + te[5].Glow);
}
...
state test1
{
    ...
    objectupdate_received(agentinfo agent, float timedilation, objectdatalist objectlist)
    {
        foreach(objdata in objectlist)
        {
            ...
            {
                received = TRUE;
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    objdata.TextureEntry[1].Glow != 1.0 ||
                    objdata.TextureEntry[2].Glow != 1.0 ||
                    objdata.TextureEntry[3].Glow != 1.0 ||
                    objdata.TextureEntry[4].Glow != 1.0 ||
                    objdata.TextureEntry[5].Glow != 1.0)
                {
                    llSay(PUBLIC_CHANNEL, "Test 1: failed");
                    displayteglow(objdata.TextureEntry);
                    result = FALSE;
                }
                llSetTimerEvent(0);
                state test2;
    ...
    objectupdate_received(agentinfo agent, float timedilation, objectdatalist objectlist)
    {
        foreach(objdata in objectlist)
        {
            if(objdata.LocalID == localid)
            {
                received = TRUE;
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    objdata.TextureEntry[1].Glow != 0.0 ||
                    objdata.TextureEntry[2].Glow != 1.0 ||
                    objdata.TextureEntry[3].Glow != 1.0 ||
                    objdata.TextureEntry[4].Glow != 1.0 ||
                    objdata.TextureEntry[5].Glow != 1.0)
    ...
    objectupdate_received(agentinfo agent, float timedilation, objectdatalist objectlist)
    {
        foreach(objdata in objectlist)
        {
            if(objdata.LocalID == localid)
            {
                ...
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    objdata.TextureEntry[1].Glow != 0.0 ||
                    objdata.TextureEntry[2].Glow != 0.0 ||
                    objdata.TextureEntry[3].Glow != 1.0 ||
                    objdata.TextureEntry[4].Glow != 1.0 ||
                    objdata.TextureEntry[5].Glow != 1.0)
                {
        ...
        foreach(objdata in objectlist)
        {
            if(objdata.LocalID == localid)
            {
                ...
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    objdata.TextureEntry[1].Glow != 0.0 ||
                    objdata.TextureEntry[2].Glow != 0.0 ||
                    objdata.TextureEntry[3].Glow != 0.0 ||
                    objdata.TextureEntry[4].Glow != 1.0 ||
                    objdata.TextureEntry[5].Glow != 1.0)
                {
        ...
        foreach(objdata in objectlist)
        {
            if(objdata.LocalID == localid)
            {
                ...
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    ...
                    objdata.TextureEntry[2].Glow != 0.0 ||
                    objdata.TextureEntry[3].Glow != 0.0 ||
                    objdata.TextureEntry[4].Glow != 0.0 ||
                    objdata.TextureEntry[5].Glow != 1.0)
                {
        ...
        foreach(objdata in objectlist)
        {
            if(objdata.LocalID == localid)
            {
                ...
                if(objdata.TextureEntry[0].Glow != 0.0 ||
                    ...
                    objdata.TextureEntry[3].Glow != 0.0 ||
                    objdata.TextureEntry[4].Glow != 0.0 ||
                    objdata.TextureEntry[5].Glow != 0.0)
                {
...
state test1b
{
    ...
    objectupdate_received(agentinfo agent, float timedilation, objectdatalist objectlist)
    {
        foreach(objdata in objectlist)
        {
            ...
            {
                received = TRUE;
                if(objdata.TextureEntry[0].Glow != 1.0 ||
                    objdata.TextureEntry[1].Glow != 0.0 ||
                    objdata.TextureEntry[2].Glow != 0.0 ||
                    objdata.TextureEntry[3].Glow != 0.0 ||
                    objdata.TextureEntry[4].Glow != 0.0 ||
