...
state test2b
{
    ...
    state_entry()
    {
        ...
        llSetTexture(TEXTURE_PLYWOOD, 1);
        llSetTimerEvent(1.0);
    }
...
state test3b
{
    ...
    state_entry()
    {
        ...
        llSetTexture(TEXTURE_PLYWOOD, 2);
        llSetTimerEvent(1.0);
    }
...
state test4b
{
    ...
    state_entry()
    {
        ...
        llSetTexture(TEXTURE_PLYWOOD, 3);
        llSetTimerEvent(1.0);
    }
...
state test5b
{
    ...
    {
        llSay(PUBLIC_CHANNEL, "Test 5: Setting face 4 to blank");
        llSetTexture(TEXTURE_PLYWOOD, 4);
        llSetTimerEvent(1.0);
    }
...
state test6b
{
    ...
    state_entry()
    {
        ...
        llSetTexture(TEXTURE_PLYWOOD, 5);
        llSetTimerEvent(1.0);
    }
