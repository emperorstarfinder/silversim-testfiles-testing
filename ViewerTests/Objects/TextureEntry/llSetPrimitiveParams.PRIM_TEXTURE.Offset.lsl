...
offsettexture(float x, float y, integer face)
{
    llSetPrimitiveParams([PRIM_TEXTURE, face, TEXTURE_BLANK, <1,1,0>,<x,y, 0>, 0]);
}
...
state test1
{
	...
	objectupdate_received(agentinfo agent, float timedilation, objectdatalist objectlist)
	{
        foreach(objdata in objectlist)
        {
            ...
            {
                received = TRUE;
                if(objdata.TextureEntry[0].OffsetU != -1 || objdata.TextureEntry[0].OffsetV != -1 ||
                    objdata.TextureEntry[1].OffsetU != 1 || objdata.TextureEntry[1].OffsetV != 1 ||
                    objdata.TextureEntry[2].OffsetU != 1 || objdata.TextureEntry[2].OffsetV != 1 ||
                    objdata.TextureEntry[3].OffsetU != 1 || objdata.TextureEntry[3].OffsetV != 1 ||
                    objdata.TextureEntry[4].OffsetU != 1 || objdata.TextureEntry[4].OffsetV != 1 ||
                    objdata.TextureEntry[5].OffsetU != 1 || objdata.TextureEntry[5].OffsetV != 1)
                {
