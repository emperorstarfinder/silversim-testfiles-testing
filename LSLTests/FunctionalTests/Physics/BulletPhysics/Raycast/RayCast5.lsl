...
default
{
	state_entry()
	{
		...
		list result = llCastRay(objectpos - (targetpos - objectpos), targetpos, [RC_DATA_FLAGS, RC_GET_NORMAL|RC_GET_ROOT_KEY]);
		...
		llSay(PUBLIC_CHANNEL, "HitNormal: " + (string)llList2Vector(result, 2));
