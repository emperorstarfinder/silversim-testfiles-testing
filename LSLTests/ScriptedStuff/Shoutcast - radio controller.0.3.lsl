...
string stream;
key texture;
integer picno = 2;    // Link number for picture
key radiopic = "6a4e4fd6-82dd-45ac-8115-b9002e42a145";    // UUID for club picture
        ...
        else if (menu_type == 1 && radio_status == 1)     // station menu
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    User = NULL_KEY;
                    llSetLinkTexture(picno, radiopic, 2);
...
state login
{
    ...
    dataserver(key requested, string data)
    {
            ...
            } else
        {
            ...
            display_line("2","You listen to DJ  : " + llKey2Name(User));
            if(texture != NULL_KEY) llSetLinkTexture(picno, texture, 2);
            state menu;
        }
        }
    }
