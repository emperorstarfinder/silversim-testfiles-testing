...
{
    if (llStringLength(prompt) > 485){
        llOwnerSay("The menu prompt is too long.  The last " + (string)(llStringLength(prompt) - 485) + " will be removed.");
        prompt = llGetSubString(prompt, 0, 485);
    }
